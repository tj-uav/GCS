...
!function t(e, n, i) {
    ...
    1: [function (t, e, n) {
        (function (n) {
            ...
            var r = t("./utils"), o = t("./polyfills"), a = r.isElectron(), s = r.isNW(), u = r.isBrowser(),
                f = u || a || s;
            i.prototype.defaults = {
                ...
                var n = t.width, i = t.height, o = this.__createCanvas(n, i), a = o.getContext("2d");
                ...
                var n = this, i = this.options, o = this.__createImage();
                ...
                var r = this.canvas, o = r.getContext("2d"), a = o.getImageData(t, e, n, i),
                    s = this.__createCanvas(n, i), u = s.getContext("2d");
                return u.rect(0, 0, n, i), u.fillStyle = "white", u.fill(), u.putImageData(a, 0, 0), this.canvas = s, this
            }, i.prototype.toFile = function (t, e) {
                var n = this, i = this.options, r = i.imageFormat;
                ...
                var a = this, s = e.replace("data:" + i + ";base64,", ""), u = new n(s, "base64");
                ...
                var o = this.__createCanvas(t, e), a = o.getContext("2d");
                return a.drawImage(r, 0, 0, t, e), this.canvas = o, this
            }, i.prototype.clear = function (t, e, n, i) {
                var r = this.canvas, o = r.getContext("2d");
                ...
                var n = this, i = this.options, a = i.quality, s = i.minQuality, u = i.maxQuality, c = i.imageFormat,
                    l = i.bufsize;
                ...
                return o.toDataURL({canvas: p, imageFormat: c, quality: t, bufsize: l}, function (t) {
                    e.call(n, t)
                }), this
    ...
    }, {"./polyfills": 3, "./utils": 4, buffer: 5}], 2: [function (t, e, n) {
        "use strict";
    ...
    }, {"./clipper": 1, "./utils": 4}], 3: [function (t, e, n) {
        "use strict";
        var i = t("fs"), r = {};
        r.writeFile = function (t, e, n) {
            ...
            var n = t.canvas, i = t.imageFormat, r = t.quality, o = t.bufsize;
            "image/jpeg" === i ? n.toDataURL(i, {quality: r, bufsize: o}, function (t, n) {
                if (t) throw t;
                e(n)
    ...
    }, {fs: 5}], 4: [function (t, e, n) {
        (function (t, n) {
            "use strict";
            var i = {};
            i.isBrowser = function () {
                var t = i.isElectron(), e = i.isNW();
                ...
                var n = t.length;
                if (n) for (var i = 0; i < n && e.call(t[i], t[i], i) !== !1; i++) ; else if ("undefined" == typeof n) for (var r in t) if (e.call(t[r], t[r], r) === !1) break
            }, i.extend = function (t) {
